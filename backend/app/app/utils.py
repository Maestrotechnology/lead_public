...
def send_push_notification(db, user_ids, message, data_message=None):
    ...
    push_service = FCMNotification(
            api_key="AAAAEzQPX8g:APA91bG0hWbY2utGm_uSxvK5-5QZKl31a2TgG_XsLiWDvz0vwUTT6Z1UjKdBbca8C-PKmtP5_cdtMZId05lkL9FJfqbLFqJDi42AuyFsh2alTuMBsMuodhm5s5_eXzTZKnMNrdxavYk6"
        )
...
def file_storage(file_name, f_name):
    ...
    base_dir = settings.BASE_UPLOAD_FOLDER+"/maestro_lead"
    ...
    file_exe = f"maestro_lead/{f_name}{dt}.{txt1}"
